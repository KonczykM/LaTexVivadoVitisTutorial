...
\newcommand{\step}[3]{
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=1.25\textwidth]{images/step\thestep.png}
        \caption{#3}
...
\subsection{Importing Board Files}
% Step 1
...
\subsection{Vitis Unfied IDE workflow}
% Step 41
